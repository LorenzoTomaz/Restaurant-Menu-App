...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     ...
                     seasoned with a spicy mix(chilli, tamarind among \
                     others) and slow cooked in a cylindrical clay or \
...
menuItem1 = MenuItem(user_id=1, name="Guanciale Chawanmushi",
                     ...
                     spicey Italian Pork Jowl (guanciale)", price="6.95",
                     course="Dessert", restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Lemon Curd Ice Cream Sandwich",
                     ...
                     chocolate macaron with cardamom meringue and \
                     cashews", price="4.25", course="Dessert",
